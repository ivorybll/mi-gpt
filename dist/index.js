...
var kProxyAgent = process.env.HTTP_PROXY ? new HttpsProxyAgent(process.env.HTTP_PROXY) : null;
...
var OpenAIClient = class {
  ...
  _init() {
    if (!this._client) {
      this._client = kEnvs.AZURE_OPENAI_API_KEY ? new AzureOpenAI({ httpAgent: kProxyAgent }) : new OpenAI({ httpAgent: kProxyAgent });
    }
  }
  _abortCallbacks = {
