import { MiNA, MiIOT, MiServiceConfig } from 'mi-service-lite';
...
declare class BaseSpeaker {
    ...
    private _response;
    private _doubaoSpeakers?;
    private _defaultSpeaker;
    switchDefaultSpeaker(speaker: string): Promise<boolean>;
}
...
declare class MiGPT {
    ...
    static create(config: MiGPTConfig): MiGPT;
    ai: MyBot;
    speaker: AISpeaker;
